...
import { AcademicCapIcon, LightBulbIcon, CodeIcon, InboxIcon, UserIcon } from '@heroicons/react/outline';
        ...
        <header className="flex absolute w-full items-center justify-between p-4 pr-5 z-10">
         <Image  className="object-contain rounded-full" src={Face} alt="profilePic"/>
            <div className="flex flex-grow justify-evenly max-w-2xl">
                <Link to="profile" smooth duration={1000}><HeaderItem title="Profile" Icon={UserIcon}/></Link>
